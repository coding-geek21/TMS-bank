...
<html>
  ...
  <body>
    ...
    <div class="container-fluid customer-details">
        <h2 style="float:left;">Our Happy Customers :)</h2>
        <img style="float:left;" src="images/Bank note.svg">
        ...
        <table style="font-size:18px;" class="table table-primary customer table-striped table-hover border-secondary">
          ...
          <?php
            ...
            if(mysqli_num_rows($result)>0){
              ...
              <tr scope="row">
                <td><?php  echo $customer['s_no'];  ?></td>
                <td><?php  echo $customer['account_no'];  ?></td>
                <td><?php  echo $customer['name'];  ?></td>
                <td><?php  echo $customer['email'];  ?></td>
                <td><?php  echo $customer['balance'];  ?></td>
                <td><a href="details.php?s_no=<?php  echo $customer['s_no'];  ?>">Details</a></td>
              </tr>
