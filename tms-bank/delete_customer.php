    ...
    <div class="row" style="width:100%;">
        ...
        <div class="col-lg-4">   
            ...
            <h3>Delete Customer</h3>
                ...
                <input type="text" name="Cust_ac_no" placeholder="Customer Account No" class="form-control" required><br>
                <input type="text" name="Cust_ac_Id" placeholder="Customer ID" required class="form-control"><br>
                <input type="text" name="reason" placeholder="Reason" required class="form-control"><br>
