...
<div class="row">
	...
	<div class="col-lg-4">
		<form method="post">
		<br><br><input type="password" name="oldpass" class="form-control" placeholder="Old Password" required><br>
		<input type="password" class="form-control" name="cnfrm" placeholder="Confirm old Password" required><br>
		<input type="password" class="form-control" name="newpass" placeholder="New Password" required><br>
